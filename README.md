...
|---|---|---|---|
| Hai Nguyen Huu Nam | Shopping Cart<br>Wishlist<br>Discussion Forum | Admin (2 pages)<br>User Account System | `/cart`, `/wishlist`, `/forum`<br>`/admin`, `/account` |
| David Huang | Reviews & Ratings<br>Blog | Sitemap<br>Admin (2 pages)<br>User Account System | `/reviews`, `/blog`<br>`/sitemap.html`, `/admin`, `/account` |
